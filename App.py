...
# Auto-expand time range until capacity is reached or max limit
max_limit = 10000
step = 1
time_range = np.arange(0, max_limit, step)
...
if valid_times.size > 0:
    ...
    st.warning("⚠️ Tank never fills — try a higher flow rate or different equation.")
